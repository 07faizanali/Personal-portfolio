export const SKILLS = [
 {
    title: "Frontend",
    icon: "assets/images/frontend-development.png",

    skills: [
        {skill: "HTML5", img: "assests/images/html.png", percentage: "80%"},
 ...
 {
    title: "Backend",
    icon: "assets/images/backend-development.png",
...
export const WORK_EXPERIENCE=[
    {
        title:'Quality Assurance & Inventory clerk at RAZVI TEXTILE - Delhi - Full Time',
        date:'may 2022- January 2023',
        responsibilities:[ "<b>Supervised Production:</b> Managed and supervised the work of embroidery (kadai) and stitching (silai) workers, ensuring timely completion and quality of products.",
        "<b>Inventory Management:</b> Monitored and maintained inventory levels, tracked stock received from embroidery and stitching departments, and ensured accurate record-keeping.",
        "<b>Quality Assurance:</b> Verified the quality and accuracy of fabrics received for manufacturing, ensuring they met company standards and matched the ordered quantity.",
        "<b>Stock Distribution:</b> Tracked and managed the distribution of stock to the shop, ensuring the right quantities were delivered as per the orders.",
        ],
    }
]
